...
color = "black", fill= "white") +
  ...
  geom_vline(mapping = 
            ...
            linetype="dashed", 
            size=1) +
  annotate("text", x=2.5 ,y=73,label="mean",hjust=0, size=3, angle=90, color="blue") +
  labs(title="Most Governments Can Shut Down Domestic Internet", subtitle = "Year: 2015", x="Shutdown Capacity", y = "Count", caption = "Source: V-Dem Dataset") +
  theme_clean()+
